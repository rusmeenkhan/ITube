 ...
 <%  
                                         try{
                                           ...
                                           { 
                                            ...
                                            subscribers=rs.getString("subscribe");
                                            uploads=rs.getString("uploads");
        ...
        <div class="col-sm-3 col-md-2 sidebar">
			<div class="top-navigation">
                ...
                %>
  <center> <h1 style="margin-top: 50px">Edit Profile</h1></center>
               ...
               <div class="row-lg-6">
                    ...
                    <div class="col-lg-6 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-block">
                                ...
                                <center class="m-t-30"> <img src="images/<%=ucode%>.jpg"  height="200" width="200">
                                    </div>
                                </center>
                            </div>
                    </div>
                    <div class="col-lg-4 col-xlg-3 col-md-5" >        
                        <Label>Edit Profile pic</Label>
                          <form method="post" ACTION="picUpload.jsp?id=<%=ucode%>" name="uploadForm" ENCTYPE='multipart/form-data'> 
                                    <input type="file" name="uploadFile" size="40" style="border:1px solid black;">
                                    <center><input type="submit" value="Upload" class="btn-primary"></center>
                          </form>  
                    </div>                
                </div> 
                      <div class="col-md-10" align="center">      
                        <form method="post" action="update.jsp" class="panel-body wrapper-lg">
                        <div class="form-group">
                          <label class="control-label"> First Name</label>
                          <input type="text" name="fname" value=<%=fname%> class="form-control input-lg">
                        </div>
                            <div class="form-group">
                          <label class="control-label"> Last Name</label>
                          <input type="text" name="lname" value=<%=lname%> class="form-control input-lg">
                        </div>
                            <div class="form-group">
                          <label class="control-label">Mobile</label>
                          <input type="text" name="mob" value=<%=mob%> class="form-control input-lg">
                        </div>
