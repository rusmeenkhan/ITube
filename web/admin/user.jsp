...
<script>
        $(document).ready(function(){
            $(".btn.btn-danger").click(function(){
                var v = $(this).attr("id"); 
                var x=$(this).attr("rel");
                $.post("Block_user.jsp",{id:v,rel:x},function(data){   
               });
          if(x=="Block"){
                                                    ...
                                                    <tbody>
                                                      <tr> 
                                                        ...
                                                        if(Block.equals("Block"))
                                                         {
                                                     %> 
                                                        <td><button id="<%=ucode%>" rel="<%=Block%>" class="btn btn-danger" style="background-color:red;color:white;border:none"><%=Block%></button></td>
                                                     <%
                                                          }
                                                          else{
                                                      %>
                                                        <td><button id="<%=ucode%>" rel="<%=Block%>" class="btn btn-danger" style="background-color:blue;color:white;border:none"><%=Block%></button></td>
                                                        <%
                                                            }
                                                           } 
                                                        %>
