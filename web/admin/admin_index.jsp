...
<script>
        $(document).ready(function(){
            $(".btn.btn-danger").click(function(){
                var v = $(this).attr("id"); 
                var x=$(this).attr("rel");
                $.post("Block_channel.jsp",{id:v,rel:x},function(data){   
               });
          if(x=="Block"){
                                           ...
                                           %>
                                                    ...
                                                    <tbody>
                                                      <tr> 
                                                        <td><%=cname%></td>
                                                        <td><%=Email%></td>
                                                        <td> <a href="/ITube\Channel_vid.jsp?channelid=<%=channel_id%>" style="color:blue">Open Channel </a></td>
                                                        <%
                                                        if(Block.equals("Block"))
                                                         {
                                                     %> 
                                                        <td><button id="<%=channel_id%>" rel="<%=Block%>" class="btn btn-danger" style="background-color:red;color:white;border:none"><%=Block%></button></td>
                                                     <%
                                                          }
                                                          else{
                                                      %>
                                                        <td><button id="<%=channel_id%>" rel="<%=Block%>" class="btn btn-danger" style="background-color:blue;color:white;border:none"><%=Block%></button></td>
                                                        <%
                                                            }
                                                           } 
                                                        %>
