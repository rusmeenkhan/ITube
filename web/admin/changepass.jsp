...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="Channel.jsp"> <i class="menu-icon fa fa-rss-square"></i>Manage Channels</a>   
                    </li>
                    <li>
                        <a href="user.jsp"> <i class="menu-icon fa fa-users"></i>Manage Users</a>   
                    </li>
                    <li>
                        <a href="Channel.jsp"> <i class="menu-icon fa fa-laptop"></i> </a>   
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <form method="post" action="changepassword.jsp" class="panel-body wrapper-lg">
            ...
            <div class="form-group">
                 ...
                 <input type="text" name="np"  class="form-control input-lg" >
            </div>
            <div class="form-group">
                 <label class="control-label">Retype Password</label>
                 <input type="text" name="rp" class="form-control input-lg" >
            </div>
