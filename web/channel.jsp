      ...
      <div class="container-fluid">
        ...
        <div class="col-sm-3 col-md-2 sidebar">
			<div class="top-navigation">
                ...
                ResultSet rs=st.executeQuery("select ucode from user where email='"+email+"'");
                if(rs.next()){
                    String ucode=rs.getString("ucode"); 
                %>
<div class="col-sm-5 col-sm-offset-3 col-md-6 col-md-offset-2 main" style="margin-left:400px">  
