			...
			<div class="top-navigation">
				...
				<div class="drop-navigation drop-navigation">
				  <ul class="nav nav-sidebar">
					...
					<li><a href="channel.jsp" class="user-icon"><span class="glyphicon glyphicon-home glyphicon-blackboard" aria-hidden="true"></span>Create new channel</a></li>
					<li><a href="Favourite.jsp" class="sub-icon"><span class="glyphicon glyphicon-home glyphicon-hourglass" aria-hidden="true"></span>Favourites</a></li>
...
%>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="main-grids" id="rusmeen">
              <%
                    ...
                    ResultSet rs2=st3.executeQuery("select * from subscribe where ucode='"+ucode+"' AND subscribe=1");
                    while(rs2.next()){
                         channelid=rs2.getString("channelid");
       ...
       <%  
            ResultSet rs1=st3.executeQuery("select * from song where channelid  IN (select channelid from subscribe where ucode='"+ucode+"' AND subscribe=1)");
            while(rs1.next())
                  { 
