 ...
 <%  
        ...
        <div class="col-sm-3 col-md-2 sidebar">
			<div class="top-navigation">
                ...
                %>
  <center> <h1 style="margin-top:60px">My Profile</h1></center>
                <div class="col-sm-10 col-sm-offset-2" >        
<div class="col-sm-5">

    <img src="images/<%=ucode%>.jpg" id="m" width=280 height=280 onmouseover="change()" onmouseout="set()">
</div>
<div class="col-sm-5">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" value=<%=fname%> class="form-control input-lg"  disabled>
                        </div>
                            <div class="form-group">
                          <label class="control-label"> Last Name</label>
                          <input type="text" value=<%=lname%> class="form-control input-lg" disabled>
                        </div>
                            <div class="form-group">
                          <label class="control-label">Mobile</label>
                          <input type="text" value=<%=mob%> class="form-control input-lg" disabled>
                        </div>
                   </form>
</div>
                </div>
