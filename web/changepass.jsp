      ...
      <div class="container-fluid">
        ...
        <div class="col-sm-3 col-md-2 sidebar">
			<div class="top-navigation">
                ...
                %>
  <center> <h1 style="margin-top:60px">Change Password</h1></center>
                <div class="col-sm-6 col-sm-offset-2" >        
              <form method="post" action="changepassword.jsp" class="panel-body wrapper-lg" style="margin-left: 100px">
                        <div class="form-group">
                          ...
                          <input type="password" name="np"  class="form-control input-lg" >
                        </div>
                            <div class="form-group">
                          <label class="control-label">Retype Password</label>
                          <input type="password" name="rp" class="form-control input-lg" >
                        </div>
